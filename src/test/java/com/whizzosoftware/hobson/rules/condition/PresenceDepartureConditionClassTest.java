...
public class PresenceDepartureConditionClassTest {
    @Test
    public void testCreateAssumptions() {
        PluginContext pctx = PluginContext.createLocal("plugin1");
        PresenceDepartureConditionClass pdcc = new PresenceDepartureConditionClass(pctx);
        ...
        assertNull(assumps.get(3).getRightTerm());
    }
}
